...
2. Get the path to the R executable, e.g. `c:\"Program Files"\R\R-4.2.1\bin\R.exe`
...
The logs are written into `Summarize_DOM_Stocks.Rout`, missing R packages, if any, can be installed by following the steps mentioned here: https://www.rdocumentation.org/packages/utils/versions/3.6.2/topics/install.packages
